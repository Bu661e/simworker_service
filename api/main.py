...
def create_app(
    *,
    ...
    @app.delete("/table-env/current")
    def clear_table_env(sim_manager: SimManager = Depends(_get_sim_manager)) -> dict[str, Any]:
        return _ok_payload(sim_manager.clear_table_env())
