...
_CASE_DIR_NAME_BY_TEST_NAME: dict[str, str] = {
    ...
    "test_stream_response_builder_reference_counts_reused_worker_stream": "api_stream_refcount",
    ...
    "test_ignore_root_path_access_log_filter_only_drops_root_path": "api_access_log_filter",
